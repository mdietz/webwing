<script id="simplex_fragment_shader" type="x-shader/x-fragment">
    ...
    void main( void ) {
        ...
        gl_FragColor = vec4( vec3( 0.5 - n, 1.0 - n, 1.5 - n ), 1.0 );
...
<script id="simplex_vertex_shader" type="x-shader/x-vertex">
    ...
    void main( void ) {
        ...
        vTexCoord3D = scale * ( mPosition.xyz + vec3( 0.0, 0.0, -time ) );
